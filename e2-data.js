...
const staffPage = (location.pathname.endsWith('/documents.html') && new URLSearchParams(location.search).get('staff')==='1') || ['/referrals.html','/intake-workspace.html','/portal.html','/team.html','/accept-invite.html','/profile.html','/customers.html','/loans.html'].some(path=>location.pathname.endsWith(path)) || (location.pathname.endsWith('/car.html') && new URLSearchParams(location.search).get('preview')==='1');
