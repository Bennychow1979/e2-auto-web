...
const staffPage = ['/portal.html','/team.html','/accept-invite.html','/profile.html','/customers.html'].some(path=>location.pathname.endsWith(path)) || (location.pathname.endsWith('/car.html') && new URLSearchParams(location.search).get('preview')==='1');
