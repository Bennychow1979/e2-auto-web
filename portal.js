...
const base=[{brand:'Honda',model:'CR-V',variant:'TC-P 2WD'},{brand:'Perodua',model:'Myvi',variant:''},...bmwModels.map(model=>({brand:'BMW',model,variant:''})),...subaruModels.map(model=>({brand:'SUBARU',model,variant:''})),...fordModels.map(model=>({brand:'FORD',model,variant:''})),...mazdaModels.map(model=>({brand:'MAZDA',model,variant:''})),...mercedesModels.map(model=>({brand:'MERCEDES-BENZ',model,variant:''})),...nissanModels.map(model=>({brand:'NISSAN',model,variant:''}))];
